...
|:--------|:--------:|:--------:|:--------:|:--------:|
| [**ChatSpot: Bootstrapping Multimodal LLMs via Precise Referring Instruction Tuning**](https://arxiv.org/pdf/2307.09474.pdf) <br> | arXiv | 2023-07-18 | [Coming soon]() | [Demo](https://chatspot.streamlit.app/) |
...
|:-----|:-----:|:----:|:-----:|
| **MGVLID** | [ChatSpot: Bootstrapping Multimodal LLMs via Precise Referring Instruction Tuning](https://arxiv.org/pdf/2307.09474.pdf) | [Link](https://huggingface.co/datasets/magicr/BuboGPT) | A high-quality instruction-tuning dataset including image-text and region-text pairs |
