...
3. The results of other models have also been updated, retrieving the answer from the beginning of the generated responses instead of the whole responses. The calcualtion is shown as bellow. The paper will be updated in two days. <details><summary>Calculation of Accuracy, Accuracy+, and Score :star2::star2:</summary>
